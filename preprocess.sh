...
DICOM_IMAGES_PATH="~/dev/avanid/data/qarc/dicom"
COMPLETED_DICOM_IMAGES_PATH="~/dev/avanid/data/qarc/completed_dicom"
NUMPY_OUTPUT_PATH="~/dev/avanid/data/qarc/numpy"
